import { Scissors, Sparkles, Loader } from "lucide-react";
  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <button
          disabled={isLoading || !selectedFile || !object.trim() || !hasPremium}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#417DF6] to-[#8E37EB] text-white px-4 py-2 mt-6 text-sm cursor-pointer rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isLoading ? (
          ...
          <div className="mt-3 h-full overflow-y-scroll">
            <div className="mb-4">
              ...
              <div className="mt-2 p-2 bg-blue-50 rounded border border-blue-200">
                <p className="text-xs text-blue-700">
                  <strong>Status:</strong> Object removed successfully
                </p>
                <p className="text-xs text-blue-600 mt-1">
                  <strong>Object Removed:</strong> {imageHistory[0]?.object}
                </p>
                <p className="text-xs text-blue-600 mt-1">
