  ...
  return (
    <div className="px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-center bg-no-repeat min-h-[80vh] sm:min-h-screen pt-16 sm:pt-0">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 md:gap-6 px-4 mb-4 sm:mb-6 md:mb-8">
        <button
          onClick={() => navigate("/ai")}
          className="w-full sm:w-auto bg-primary text-white px-6 sm:px-8 md:px-10 py-2.5 sm:py-3 md:py-4 rounded-lg hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer text-sm sm:text-base md:text-lg font-medium shadow-lg hover:shadow-xl"
        >
          Start creating now
        </button>
        <button className="w-full sm:w-auto bg-white px-6 sm:px-8 md:px-10 py-2.5 sm:py-3 md:py-4 rounded-lg border border-gray-300 hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer text-sm sm:text-base md:text-lg font-medium shadow-md hover:shadow-lg">
          Watch demo
        </button>
      </div>

      {/* Social Proof */}
      <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-4 mx-auto text-gray-600 text-sm sm:text-base mb-4 sm:mb-6 md:mb-8">
      ...
      <div className="mt-2 sm:mt-4 md:mt-6 lg:mt-8 pb-8 sm:pb-12 md:pb-16">
        <CompanyLogoMarquee />
      </div>
    </div>
  );
